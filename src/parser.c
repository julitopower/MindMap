...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_mindmap = 15,                   /* mindmap  */
  YYSYMBOL_nodes = 16,                     /* nodes  */
  YYSYMBOL_node = 17,                      /* node  */
  YYSYMBOL_content = 18,                   /* content  */
  YYSYMBOL_attributes = 19,                /* attributes  */
  YYSYMBOL_attributes_list = 20,           /* attributes_list  */
  YYSYMBOL_attributes_l = 21,              /* attributes_l  */
  YYSYMBOL_attribute = 22,                 /* attribute  */
  YYSYMBOL_value = 23,                     /* value  */
  YYSYMBOL_unit = 24                       /* unit  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "LEVEL", "NAME",
  "ARROW", "REAL", "INT", "QSTR", "'\\n'", "'['", "']'", "','", "'='",
  "$accept", "mindmap", "nodes", "node", "content", "attributes",
  "attributes_list", "attributes_l", "attribute", "value", "unit", YY_NULLPTR
};
...
#line 1172 "/home/julio_delg/projects/MindMap/src/parser.c"
